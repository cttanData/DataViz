...
```{r message = FALSE, warning= FALSE, fig.width=80, fig.align="centre", fig.cap = "Bipartite"}
...
plot(bg, layout=layout.bipartite, 
     vertex.color=c("orange","pink")[V(bg)$type+1], vertex.size=18, vertex.label.cex=9,
     vertex.shape = shape[V(bg)$type+1],
     edge.width = E(bg)$weights*5,
     edge.label=E(bg)$weights, edge.label.cex=8, edge.label.color ="black")
```
