...
```{r message = FALSE, fig.width = 25, fig.align ="centre", fig.cap = "Bipartite Graph of Credit(Orange) and Loyalty(Pink) Cards.", warning = FALSE}
...
plot(bg, layout=layout.bipartite, 
     ...
     edge.width = E(bg)$weights*0.2,
     edge.label=E(bg)$weights, edge.label.cex=0.5, edge.label.color ="black")
