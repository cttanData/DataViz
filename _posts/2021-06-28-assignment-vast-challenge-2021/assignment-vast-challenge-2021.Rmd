...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, error = FALSE, fig.retina = 3,layout="l-body", fig.height = 6*0.618, fig.align='centre')
```
...
```{r, fig.align='centre'}
# running timevis
timevis::timevis(data = visfull_ds, groups=vis_gp, height="400px", width = "700px")
```
