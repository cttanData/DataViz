...
```{r,layout="l-body",fig.height = 6, fig.align='centre', echo=FALSE}
...
A quick look was that 1321 (veh ID 11) deemed to be in his own community based on place of interest. When zoom into breakfast session, 1415 (veh ID 2) and 9683 (veh ID 33, Brewed Served) tend to be alone and not i the common breakfast location Hallowed Grounds. 2142 and 3547 shared common breakfast interest at Coffee Cameleon . it also interesting to note that 2540 (veh ID 7, female) and 9683 (male) seemed to visit the hotel twice a week a during lunch time with some regular pattern. Other than them, the next person in the company that visited the hotel was the CEO.
