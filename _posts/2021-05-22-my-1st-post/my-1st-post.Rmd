...
description: |
  The first DataViz MakeOver task from ISSS608: Visual Analytics.
  (Using Tableau Desktop 2021.1, Tableau Prep Builder 2021.1 & Office 365 Excel)
draft: true
author:
  - name: cttanData
...
In this article, we will show you how to plot a figure with multiple histograms by using [**ggplot2**](https://ggplot2.tidyverse.org) and [**ggpubr**](https://rpkgs.datanovia.com/ggpubr/) packages. 
...
To insert a table & graph.

Table Header    | Content
--------------- | --------
Mt Fugi         | ![Holiday](image/IMG_5050.jpg){ width=50% }
Welcome         | Bye!
